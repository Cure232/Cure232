...
def frequency_bit_test(bit_string: str) -> float:
    ...
    basic_logger.info(f"frequency_bit_test returned {p_value}")
    return p_value
...
def consecutive_bits_test(bit_string: str) -> float:
    ...
    basic_logger.info(f"consecutive_bits_test returned {p_value}")
    return p_value
...
def longest_sequence_test(bit_string: str) -> float:
    ...
    basic_logger.info(f"longest_sequence_test returned {p_value}")
    return p_value